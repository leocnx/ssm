package top.auok.cbps.ssm.dao.base.impl;
...
import top.auok.cbps.ssm.exception.BizException;
...
public abstract class BaseDaoImpl<T> extends SqlSessionDaoSupport implements BaseDao<T> {
	...
	/**
	 * inject SqlSessionTemplate instance by spring at subclass
	 */
	@Autowired
	...
	/**
	 * get mybatis mapper's namespace
	 */
